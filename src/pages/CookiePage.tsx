          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <div>
                  ...
                  <p>
                    These cookies remember your preferences and settings, such
                    as your preferred language, theme, and personalized
                    recommendations.
                  </p>
                </div>
              </div>
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <p>
                  We do not control these third-party cookies. Please refer to
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p>
                    <strong>Email:</strong> privacy@wordwise.com
                  </p>
                  <p>
                    <strong>Address:</strong> WordWise Privacy Team, 123 Book
