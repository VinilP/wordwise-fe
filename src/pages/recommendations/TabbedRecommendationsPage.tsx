          ...
          {activeTab === 'ai' ? (
            <div className="p-6">
              <div className="mb-4">
                ...
                <p className="text-gray-600">
                  Recommendations based on your reading history, reviews, and favorite books
                </p>
              </div>
                ...
                {aiLoading ? (
                  ...
                  <div className="text-center py-12">
                    <div className="text-red-600 mb-4">
                      ...
                      <p className="text-sm">{aiErrorDetails?.message || 'An error occurred'}</p>
                    </div>
                    <button
                      onClick={() => refetchAI()}
            ...
            <div className="p-6">
              ...
              {popularLoading ? (
                ...
                <div className="text-center py-12">
                  <div className="text-red-600 mb-4">
                    <p className="text-lg font-medium">Failed to load popular books</p>
                    <p className="text-sm">{popularErrorDetails?.message || 'An error occurred'}</p>
                  </div>
                  <button
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {popularBooks.map((book) => (
                    <BookCard key={book.id} book={book} data-testid="recommendation-card" />
                  ))}
                </div>
              )}
            </div>
