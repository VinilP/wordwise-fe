...
test.describe('Complete User Workflows', () => {
  ...
  test('Complete User Registration and Book Review Workflow', async () => {
    ...
    await page.fill('[data-testid="review-content"]', 'This is an amazing classic novel!');
    await page.click('[data-testid="rating-5"]');
    await page.click('[data-testid="submit-review-button"]');

    // Step 8: Verify review was created
    await expect(page.locator('text=This is an amazing classic novel!')).toBeVisible();
    await expect(page.locator('[data-testid="rating-display"]')).toContainText('5');
