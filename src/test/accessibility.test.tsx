...
describe('Accessibility Tests', () => {
  ...
  describe('BookSearch Component', () => {
    test('has proper search landmark', () => {
      ...
      expect(searchRegion).toHaveAttribute('aria-label', 'Book search and filters');
    });
    ...
    test('search input has proper labels and descriptions', () => {
      ...
      const searchInput = screen.getByLabelText(/search books by title or author/i);
    ...
    test('filter buttons have proper ARIA attributes', async () => {
      ...
      const genreButtons = screen.getAllByRole('button', { name: /add.*filter/i });
  ...
  describe('LoadingSpinner Component', () => {
    ...
    test('has screen reader only text', () => {
      ...
      const srOnlyText = screen.getByText('Loading content', { selector: '.sr-only' });
