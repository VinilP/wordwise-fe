  ...
  const features = [
    {
      ...
      description:
        "Explore a vast collection of books across different genres and find your next favorite read.",
    },
    {
      icon: (
        <svg
      ...
      title: "Rate & Review",
      description:
        "Share your thoughts on books you've read and help others discover great reads through your reviews.",
    },
    {
      icon: (
        <svg
    ...
    },
    {
      ...
      title: "Community",
      description:
        "Connect with fellow book lovers, share recommendations, and discover new authors together.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 relative z-10">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Your intelligent companion for discovering, reviewing, and sharing
              amazing books
            </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Discover the features that make WordWise the perfect platform for
            book lovers
          </p>
        </div>
      ...
      <div className="bg-gray-900 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Join thousands of book lovers who are already discovering their next
            favorite read
          </p>
          {!user && (
            <Link
