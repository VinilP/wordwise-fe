...
describe('ReviewHistory', () => {
  ...
  it('renders loading state initially', () => {
    mockUserService.getProfileWithDetails.mockImplementation(() => new Promise(() => {})); // Never resolves
  ...
  it('renders reviews when loaded successfully', async () => {
    mockUserService.getProfileWithDetails.mockResolvedValue(mockProfileWithDetails);
  ...
  it('renders empty state when no reviews', async () => {
    ...
    expect(screen.getByText('Start reading books and share your thoughts with reviews.')).toBeInTheDocument();
  ...
  it('renders error state when reviews loading fails', async () => {
    ...
    mockUserService.getProfileWithDetails.mockRejectedValue(new Error(errorMessage));
  ...
  it('shows updated date when review was modified', async () => {
    ...
    mockUserService.getProfileWithDetails.mockResolvedValue(profileWithUpdatedReview);
  ...
  it('handles multiple reviews correctly', async () => {
    ...
    mockUserService.getProfileWithDetails.mockResolvedValue(profileWithMultipleReviews);
