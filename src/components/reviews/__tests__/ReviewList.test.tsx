...
describe("ReviewList", () => {
  ...
  it("renders all reviews when provided", () => {
    ...
    expect(
      screen.getByText("Another excellent review with detailed analysis."),
    ).toBeInTheDocument();
  ...
  it("passes onEditReview callback to ReviewCard components", () => {
    render(
      <ReviewList reviews={mockReviews} onEditReview={mockOnEditReview} />,
    );
  ...
  it("passes onDeleteReview callback to ReviewCard components", () => {
    render(
      <ReviewList reviews={mockReviews} onDeleteReview={mockOnDeleteReview} />,
    );
  ...
  it("passes showBookInfo prop to ReviewCard components", () => {
    ...
    render(<ReviewList reviews={reviewsWithBooks} showBookInfo={true} />);
