...
describe('ReviewEditModal', () => {
  ...
  it('renders modal content when isOpen is true and review is provided', () => {
    ...
    expect(screen.getByText('for "The Great Gatsby" by F. Scott Fitzgerald')).toBeInTheDocument();
  });
  ...
  it('displays review form with initial data', () => {
    ...
    expect(screen.getByDisplayValue('This is a great book with excellent character development.')).toBeInTheDocument();
  ...
  it('calls onSubmit with correct data when form is submitted', async () => {
    ...
    const textarea = screen.getByDisplayValue('This is a great book with excellent character development.');
    fireEvent.change(textarea, { 
      target: { value: 'Updated review content that is long enough for validation.' } 
    });
