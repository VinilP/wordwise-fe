...
describe('BookCard', () => {
  it('renders book information correctly', () => {
    ...
    expect(screen.getByText('Test Book Title', { selector: 'h3' })).toBeInTheDocument();
  ...
  it('handles image load error by setting placeholder', async () => {
    ...
    await waitFor(() => {
      const image = screen.getByAltText('Cover of Test Book Title by Test Author') as HTMLImageElement;
      expect(image).toBeInTheDocument();
