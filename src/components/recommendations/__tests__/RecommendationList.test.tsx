...
describe('RecommendationList', () => {
  it('renders recommendations correctly', () => {
    ...
    expect(screen.getByText('2 personalized recommendations based on your reading history')).toBeInTheDocument();
  ...
  it('displays error state correctly', () => {
    ...
    expect(screen.getAllByText('Failed to load recommendations')).toHaveLength(2);
  ...
  it('displays correct number of recommendations in header', () => {
    ...
    const headerText = screen.getByText((content, element) => {
      return element?.textContent === '2 personalized recommendations based on your reading history';
    });
  ...
  it('displays singular form for single recommendation', () => {
    ...
    // Check the header text more specifically
    const headerText = screen.getByText((content, element) => {
      return element?.textContent === '1 personalized recommendation based on your reading history';
    });
    expect(headerText).toBeInTheDocument();
  });
  ...
  it('displays footer message', () => {
    ...
    expect(screen.getByText('Recommendations are updated based on your reading activity and preferences.')).toBeInTheDocument();
  });
