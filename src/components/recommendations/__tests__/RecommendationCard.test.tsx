...
const mockRecommendation: Recommendation = {
  book: mockBook,
  reason: 'Based on your love for mystery novels and high-rated books, this thriller should be perfect for you.',
  confidence: 0.85,
};
...
describe('RecommendationCard', () => {
  it('renders recommendation information correctly', () => {
    renderWithRouter(<RecommendationCard recommendation={mockRecommendation} />);
  ...
  it('displays correct confidence label for low confidence', () => {
    renderWithRouter(<RecommendationCard recommendation={mockLowConfidenceRecommendation} />);
  ...
  it('handles image load error by setting placeholder', () => {
    ...
    const image = screen.getByAltText('Cover of Test Book Title') as HTMLImageElement;
  ...
  it('displays "No ratings yet" when book has no reviews', () => {
    ...
    renderWithRouter(<RecommendationCard recommendation={recommendationNoRating} />);
  ...
  it('displays medium confidence correctly', () => {
    ...
    renderWithRouter(<RecommendationCard recommendation={mediumConfidenceRecommendation} />);
