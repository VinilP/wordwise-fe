...
describe("LoadingSpinner", () => {
  ...
  it("renders with custom text", () => {
    ...
    expect(
      screen.getByText("Please wait...", { selector: "p" }),
    ).toBeInTheDocument();
    expect(
      screen.getByText("Please wait...", { selector: ".sr-only" }),
    ).toBeInTheDocument();
  });
  ...
  it("renders with custom aria-label", () => {
    ...
    expect(spinner).toHaveAttribute(
      "aria-label",
      "Loading books from the library",
    );
  });
  ...
  it("has proper text structure for screen readers", () => {
    ...
    const srOnlyText = screen.getByText("Loading books", {
      selector: ".sr-only",
    });
