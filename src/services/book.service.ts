...
import type { Book, PaginatedBooks, PaginationParams, SearchFilters } from '@/types';
...
export const bookService = {
  ...
  async getBooks(
    ...
    return {
      ...
      hasNextPage: backendData.pagination ? backendData.pagination.page < backendData.pagination.totalPages : false,
      hasPreviousPage: backendData.pagination ? backendData.pagination.page > 1 : false,
    };
  },
